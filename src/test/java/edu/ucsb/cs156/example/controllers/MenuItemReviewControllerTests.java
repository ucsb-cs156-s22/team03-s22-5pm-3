...
public class MenuItemReviewControllerTests extends ControllerTestCase {
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
        ...
        MenuItemReview menuItemReview = MenuItemReview.builder()
            .itemId(1L)
            .reviewerEmail("joseph_ng@ucsb.edu")
            .stars(0)
            .dateReviewed(ldt)
    ...
    public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
            ...
            MvcResult response = mockMvc.perform(
                post("/api/MenuItemReview/post?itemId=1&reviewerEmail=joseph_ng@ucsb.edu&stars=1&dateReviewed=2022-01-03T00:00:00&comments=Hello World") // NOTE
                    .with(csrf()))
                .andExpect(status().isOk()).andReturn();
    ...
    public void admin_can_edit_an_existing_menuitemreview() throws Exception {
            ...
            MenuItemReview menuItemReviewEdited = MenuItemReview.builder()
                .itemId(2L)
                .reviewerEmail("joseph_ng@.cs.ucsb.edu")
                .stars(5)
                .dateReviewed(ldt2)
                .comments("Bye World")
                .build();
