...
public class HelpRequestControllerTests extends ControllerTestCase {
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
        ...
        // arrange
        LocalDateTime ldt = LocalDateTime.parse("2022-04-29T00:00:00");

        HelpRequest helpRequest = HelpRequest.builder()
                .requesterEmail("test_email@email.com")
                .teamId("test-team-3")
    ...
    public void logged_in_user_can_get_all_helprequests() throws Exception {
        ...
        // arrange
        LocalDateTime ldt1 = LocalDateTime.parse("2022-04-29T00:00:00");
        ...
        LocalDateTime ldt2 = LocalDateTime.parse("2022-04-30T00:00:00");

        HelpRequest helpRequest2 = HelpRequest.builder()
                .requesterEmail("test_email-2@email.com")
                .teamId("test-team-3-2")
    ...
    public void an_admin_user_can_post_a_new_help_request() throws Exception {
        ...
        HelpRequest helpRequest1 = HelpRequest.builder()
                .requesterEmail("test-email@email.com")
                .teamId("test-team-3")
                .tableOrBreakoutRoom("test-table")
                .requestTime(ldt1)
                .explanation("test-explanation")
